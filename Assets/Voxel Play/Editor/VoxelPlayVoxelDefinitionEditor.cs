    ...
    public class VoxelPlayVoxelDefinitionEditor : UnityEditor.Editor
    {
        ...
        void CheckAnimationTexturesImportSettings ()
        {
            ...
            for (int k = 0; k < vd.animationTextures.Length; k++) {
                VoxelPlayEditorCommons.CheckImportSettings (vd.animationTextures [k].textureTop);
                VoxelPlayEditorCommons.CheckImportSettings (vd.animationTextures [k].textureSide);
                VoxelPlayEditorCommons.CheckImportSettings (vd.animationTextures [k].textureBottom);
            }
        }
