...
namespace VoxelPlay
{
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour
    {
        ...
        bool HitVoxelFast (Vector3 origin, Vector3 direction, int damage, out VoxelHitInfo hitInfo, float maxDistance = 0, int damageRadius = 1, bool addParticles = true, bool playSound = true, int layerMask = -1)
        {
        ...
        /// </summary>
        public bool BuildVoxelHitInfo(out VoxelHitInfo hitInfo, Vector3 voxelCenter, Vector3 hitPoint, Vector3 normal) {
            hitInfo = new VoxelHitInfo {
                normal = normal,
