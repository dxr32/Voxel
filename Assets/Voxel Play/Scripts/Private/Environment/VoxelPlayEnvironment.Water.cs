...
namespace VoxelPlay
{
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour
    {
        ...
        /// </summary>
        void MakeSurroundingWaterExpand (Vector3 position, int lifeTime = 24)
        {
        ...
        void UpdateWaterFlood ()
        {
            ...
            while (index != -1) {
                if (now >= waterFloodSources.nodes [index].spreadNext) {
                    ...
                    float distSqr = FastVector.SqrDistanceXZ (ref currentAnchorPos, ref waterFloodSources.nodes [index].position);
