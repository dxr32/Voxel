...
namespace VoxelPlay
{
    ...
    public delegate VoxelDefinition CustomVoxelDefinitionProviderDelegate (Vector3 position, VoxelDefinition vd);
    ...
    public class ConnectedVoxel : ScriptableObject
    {
        ...
        public VoxelDefinition ResolveVoxelDefinition (Vector3 position, VoxelDefinition vd)
        {
