...
namespace VoxelPlay
{
    ...
    public partial class VoxelPlayThirdPersonController : VoxelPlayCharacterControllerBase
    {
        ...
        void LateUpdate ()
        {
            ...
            if (crosshairOnBlock) {
                crosshairOnBlock = FastVector.SqrDistance (ref _crosshairHitInfo.voxelCenter, ref curPos) < crosshairMaxDistance * crosshairMaxDistance;
                if (!crosshairOnBlock) {
            ...
            if (changeOnBlock) {
                ...
                if (d < -0.2f) {
                    ...
                    crosshair.LookAt (hitInfo.point + _crosshairHitInfo.normal);
                } else {
                    crosshair.localRotation = Misc.quaternionZero;
                }
